...
Command (
name ="/spell",
description ="Spelling practice or pronounce custom word",
usage ="/spell [word]",
handler_name ="handle_spell",
),
Command (
name ="/dictate",
description ="Start timed dictation spelling test",
usage ="/dictate",
handler_name ="handle_dictate",
),
Command (
name ="/theme",
description ="Customize interface colors",
usage ="/theme [custom|dark|light] [ink_hex] [panel_hex] [accent_hex] [text_hex]",
handler_name ="handle_theme",
),
Command (
name ="/survey",
description ="Complete student welcome survey",
usage ="/survey",
handler_name ="handle_survey",
),
Command (
name ="/history",
description ="View stats, learning analysis and chat history logs",
usage ="/history",
handler_name ="handle_history",
),
Command (
name ="/image",
description ="Analyze an image file with OCR and TutorBot explanation",
usage ="/image <path>",
handler_name ="handle_image",
),
Command (
name ="/exit",
